...
var PathFigureUtil = /** @class */ (function (_super) {
    ...
    PathFigureUtil.a = function (a) {
        ...
        try {
            for (var _a = tslib_1.__values(fromEnum(a._segments)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var c = _b.value;
                switch (c.a) {
                    case 4:
                        var d = c;
                    ...
                    case 3:
                        ...
                        try {
                            for (var _c = tslib_1.__values(fromEnum(h._points)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var j = _d.value;
                                i._points.add(j);
                            }
                        }
