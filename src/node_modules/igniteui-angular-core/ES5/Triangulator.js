    ...
    Triangulator.prototype.w = function () {
        {
            ...
            for (var ab = n; ab < o; ++ab) {
                m.e();
                if (ab < b) {
                    p = c.item(e_1._inner[ab]);
                    q = d.item(e_1._inner[ab]);
                }
                else if (ab == b) {
                    p = f.x;
                    q = f.y;
                ...
                for (var ad = j.c; ad != null; ad = ac) {
                    ...
                    x = aa_1.v3;
                    if (r < b) {
                        s = c.item(e_1._inner[r]);
                        t = d.item(e_1._inner[r]);
                    }
                    else if (r == b) {
                        s = f.x;
                        t = f.y;
                    ...
                    if (u < b) {
                        v = c.item(e_1._inner[u]);
                        w = d.item(e_1._inner[u]);
                    }
                    else if (u == b) {
                        v = f.x;
                        w = f.y;
                    ...
                    if (x < b) {
                        y = c.item(e_1._inner[x]);
                        z = d.item(e_1._inner[x]);
                    }
                    else if (x == b) {
                        y = f.x;
                        z = f.y;
                ...
                try {
                    for (var _a = tslib_1.__values(fromEnum(m)), _b = _a.next(); !_b.done; _b = _a.next()) {
                        var af = _b.value;
                        var ag = new Triangle();
                        ag.v1 = af.a;
                        ag.v2 = af.b;
            ...
            if (o == b) {
                for (var ah = k.c; ah != null; ah = ah.a) {
                    ...
                    if (aa_1.v1 < b && aa_1.v2 < b && aa_1.v3 < b) {
                        i.add(((function () {
                            var $ret = new Triangle();
                            $ret.v1 = e_1._inner[aa_1.v1];
                            $ret.v2 = e_1._inner[aa_1.v2];
                            $ret.v3 = e_1._inner[aa_1.v3];
                            return $ret;
                        })()));
                    }
                }
