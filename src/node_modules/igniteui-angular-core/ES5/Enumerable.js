...
var Enumerable = /** @class */ (function (_super) {
    ...
    Enumerable._p = function ($tSource, $tResult, a, b) {
        var _a, _b, c, _c, _d, d, e_4_1, e_5_1, e_5, _e, e_4, _f;
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 2:
                    ...
                    _c = tslib_1.__values(fromEnum(b(c))), _d = _c.next();
                    _g.label = 3;
                case 3:
    ...
    Enumerable._i = function ($tSource, a, b) {
        var _a, _b, c, e_11_1, _c, _d, d, e_12_1, e_11, _e, e_12, _f;
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                case 0:
    ...
    Enumerable.h = function ($tResult, a) {
        ...
        try {
            for (var _a = tslib_1.__values(fromEn(a)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var d = _b.value;
    ...
    Enumerable._q = function ($tSource, $tCollection, $tResult, a, b, c) {
        var _a, _b, d, _c, _d, e, e_22_1, e_23_1, e_23, _e, e_22, _f;
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    _g.trys.push([0, 11, 12, 13]);
                ...
                case 2:
                    _g.trys.push([2, 7, 8, 9]);
                    _c = tslib_1.__values(fromEnum(b(d))), _d = _c.next();
                    _g.label = 3;
                case 3:
                    if (!!_d.done) return [3 /*break*/, 6];
                    e = _d.value;
