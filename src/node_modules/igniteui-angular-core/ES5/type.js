...
var EnumUtil = /** @class */ (function () {
    ...
    EnumUtil.toDouble = 
    // TODO: Fill out remaining IConvertible implementation
    function (enumType, value, provider) {
        return value.value;
    };
...
export function getEn(arr) {
    var arr_1, arr_1_1, item, e_2_1, e_2, _a;
...
export function fromDict(v) {
    var v_1, v_1_1, item, _a, key, value, e_3_1, e_3, _b;
