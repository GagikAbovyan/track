...
export declare class Guid extends ValueType implements IFormattable, IComparable, IComparable$1<Guid>, IEquatable$1<Guid> {
    ...
    private static af(a, b, c, d);
    private static ag(a, b, c, d, e);
    private static z(a);
    static tryParse(a: string, b: Guid): {
        ret: boolean;
        p1: Guid;
    };
    private static n(a, b, c);
    private static o(a, b);
    private static ah(a);
    private static p(a, b);
    private static q(a, b);
    private static k(a, b, c, d, e);
    private static l(a, b, c, d, e, f);
    private static i(a, b, c, d, e);
    private static j(a, b, c, d, e, f);
