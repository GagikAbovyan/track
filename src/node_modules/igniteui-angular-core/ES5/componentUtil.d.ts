...
export declare class CollectionAdapter<T, J> {
    ...
    constructor(query: any, target: IList$1<J>, allList: T[], toTarget: (item: T) => J, onItemAdded: (item: T) => void, onItemRemoved: (item: T) => void);
...
export declare function initializePropertiesFromCss(ele: Element, comp: any, cssPrefix: string, ignoredProperties?: Set<string>): void;
