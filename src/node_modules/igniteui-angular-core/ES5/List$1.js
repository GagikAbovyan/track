...
var List$1 = /** @class */ (function (_super) {
            ...
            case 1:
                {
                    ...
                    try {
                        for (var _a = tslib_1.__values(fromEnum(c)), _b = _a.next(); !_b.done; _b = _a.next()) {
                            var d = _b.value;
                            _this.add(d);
                        }
                    }
    ...
    List$1.prototype.t = function (a, b) {
        ...
        var j_ = a;
        try {
            for (var _a = tslib_1.__values(fromEn(b)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var item_ = _b.value;
    ...
    List$1.prototype.s = function (a, b) {
        ...
        var j_ = a;
        try {
            for (var _a = tslib_1.__values(fromEnum(b)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var item_ = _b.value;
                this._inner.splice(j_, 0, item_);
                j_++;
            }
