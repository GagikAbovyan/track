...
var DescriptionTreeReconciler = /** @class */ (function (_super) {
    ...
    DescriptionTreeReconciler.b = function (a, b) {
        ...
        DescriptionTreeReconciler.e(c, a, b);
        return c;
    };
    DescriptionTreeReconciler.e = function (a, b, c) {
        c.f = b.f;
            ...
            if (c.b(j.c)) {
                if (!Base.equalsStatic(j, c.a(j.c))) {
                    ...
                    if (typeCast(DescriptionTreeNode.$, j.b) !== null && typeCast(DescriptionTreeNode.$, k.b) !== null) {
                        ...
                        var m = k.b;
                        if (l.h == m.h) {
                            DescriptionTreeReconciler.e(a, l, m);
                        }
                        else {
                            h.add(c.a(j.c));
                        }
                ...
                if (!DescriptionTreeReconciler.a(ag.b, c.a(ag.c).b)) {
                    ...
                    for (var aj = 0; aj < ah.length; aj++) {
                        ...
                        if (typeCast(DescriptionTreeNode.$, ak) !== null && typeCast(DescriptionTreeNode.$, al) !== null) {
                            ...
                            var an = al;
                            if (am.h == an.h) {
                                DescriptionTreeReconciler.e(a, am, an);
                            }
                            else {
        ...
        for (var ay = 0; ay < ae.count; ay++) {
            DescriptionTreeReconciler.f(a, b, c, b.a(ae._inner[ay].c), ae._inner[ay]);
        }
    };
    DescriptionTreeReconciler.f = function (a, b, c, d, e) {
        var f = false;
        var g = d.b;
        var h = e.b;
        if (g.length > 0) {
        ...
        if (f) {
            ...
            for (var t = 0; t < l.count; t++) {
                var u = l._inner[t];
                if (!m.containsKey(u.f)) {
                    u.c = true;
                }
            }
            for (var v = 0; v < n.count; v++) {
                var w = n._inner[v];
                if (!k.containsKey(w.f)) {
                    w.b = true;
                }
                else {
                    k.item(w.f).e = v;
            ...
            for (var ac = 0; ac < n.count; ac++) {
                ...
                if (ad.b) {
                    ...
                    var ah = k.item(ad.f);
                    if (ah.d == ah.e) {
                        DescriptionTreeReconciler.e(a, ah.a, ad.a);
                        continue;
                    }
            ...
            for (var ao = 0; ao < an; ao++) {
                if (ao >= g.length) {
                    ...
                    if (typeCast(DescriptionTreeNode.$, ar) !== null && typeCast(DescriptionTreeNode.$, as) !== null) {
                        ...
                        var au = as;
                        if (at.h == au.h) {
                            DescriptionTreeReconciler.e(a, at, au);
                        }
                        else {
