import { Base, DomWrapper, DomRenderer, Type } from "./type";
...
export declare class BrushUtil extends Base {
    ...
    private static k(a, b, c, d);
    private static j(a, b, c, d);
    private static i(a, b, c, d);
    private static c(a, b, c, d);
    private static b(a, b, c, d);
