...
export declare class StackedFragmentSeriesDescription extends Description {
    ...
    private a5;
    legendItemBadgeTemplate: string;
    private au;
    actualLegendItemBadgeTemplate: string;
    private a6;
    legendItemTemplate: string;
    private av;
    actualLegendItemTemplate: string;
    private a7;
