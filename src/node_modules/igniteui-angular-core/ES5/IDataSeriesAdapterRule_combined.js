...
import { Type, Base, String_$type, fromEnum, markType, IEnumerable_$type, typeCast, Array_$type, runOn, EnumUtil, Number_$type, typeGetValue, INotifyPropertyChanged_$type, PropertyChangedEventArgs, delegateCombine } from "./type";
...
var DataSeriesAdapterRunContext = /** @class */ (function (_super) {
    ...
    DataSeriesAdapterRunContext.prototype.getCurrentPath = function () {
        ...
        var b = true;
        try {
            for (var _a = tslib_1.__values(fromEnum(this.o)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var c = _b.value;
                if (b) {
                    b = false;
                }
...
var DataSeriesAdapterImplementation = /** @class */ (function (_super) {
    ...
    function DataSeriesAdapterImplementation() {
        ...
        _this.p = null;
        _this.q = null;
        _this.m = new Dictionary$2(Base.$, IDataSourceLocalDataProvider_$type, 0);
        _this.n = null;
        ...
        _this.ah(_this.rules);
        var a = _this.rules;
        a.collectionChanged = delegateCombine(a.collectionChanged, runOn(_this, _this.an));
        return _this;
    }
    DataSeriesAdapterImplementation.prototype.u = function (a, b) {
        var c = stringEmpty();
        if (this.p != null) {
            c = this.p(a);
        }
    ...
    DataSeriesAdapterImplementation.prototype.ah = function (a) {
    };
    DataSeriesAdapterImplementation.prototype.an = function (a, b) {
        this.refresh();
    };
    ...
    Object.defineProperty(DataSeriesAdapterImplementation.prototype, "supportedSeriesTypes", {
        ...
        set: function (a) {
            ...
            this.c = a;
            if (b != this.c) {
                this.ac("SupportedSeriesTypes", b, this.c);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(DataSeriesAdapterImplementation.prototype, "includedProperties", {
        ...
        set: function (a) {
            ...
            this.b = a;
            if (b != this.b) {
                this.ac("IncludedProperties", b, this.b);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(DataSeriesAdapterImplementation.prototype, "excludedProperties", {
        ...
        set: function (a) {
            ...
            this.a = a;
            if (b != this.a) {
                this.ac("ExcludedProperties", b, this.a);
            }
        },
        enumerable: true,
        configurable: true
    ...
    DataSeriesAdapterImplementation.prototype.ac = function (a, b, c) {
        this.ai(a, b, c);
        if (this.propertyChanged != null) {
            this.propertyChanged(this, new PropertyChangedEventArgs(a));
        }
    };
    DataSeriesAdapterImplementation.prototype.ai = function (a, b, c) {
        switch (a) {
            case "ItemsSource":
                this.refresh();
                break;
    ...
    DataSeriesAdapterImplementation.prototype.x = function () {
        try {
            for (var _a = tslib_1.__values(fromEnum(this.m.keys)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var a = _b.value;
                var b = this.m.item(a);
    ...
    DataSeriesAdapterImplementation.prototype.am = function (a) {
        var b = true;
    ...
    DataSeriesAdapterImplementation.prototype.aq = function (a) {
        var b = 0;
    ...
    DataSeriesAdapterImplementation.prototype.al = function (a) {
        ...
        var this_1 = this;
        try {
            for (var _a = tslib_1.__values(fromEnum(b.keys)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var h = _b.value;
                _loop_1(h);
            }
        }
    ...
    DataSeriesAdapterImplementation.prototype.ap = function (a) {
        for (var b = 0; b < this.rules.count; b++) {
            this.ao(a, this.rules._inner[b]);
        }
    };
    DataSeriesAdapterImplementation.prototype.ao = function (a, b) {
        b.evaluate(a);
    };
    DataSeriesAdapterImplementation.prototype.l = function (a) {
        if (a != null && this.m.containsKey(a)) {
            return this.m.item(a);
        }
        return this.g.getDataProvider(a);
    };
    DataSeriesAdapterImplementation.prototype.aj = function (a, b, c, d) {
        var e = this.l(b);
        this.w(e, a.getCurrentDataSource(), d);
        a.pushDataSource(e);
        a.pushPath(c);
        this.ap(a);
        a.popPath();
    ...
    DataSeriesAdapterImplementation.prototype.w = function (a, b, c) {
        if (a.dataSource != null) {
            this.m.addItem(a.dataSource, a);
        }
        if (b != null) {
