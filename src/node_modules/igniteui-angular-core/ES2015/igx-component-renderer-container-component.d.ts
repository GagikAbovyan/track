...
export declare class IgxComponentRendererContainerComponent {
    ...
    private _injector;
    constructor(_renderer: Renderer2, _document: any, _elRef: ViewContainerRef, _ngZone: NgZone, _componentFactoryResolver: ComponentFactoryResolver, _injector: Injector);
