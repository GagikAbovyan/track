...
export declare abstract class XmlReader extends Base implements IDisposable {
    ...
    private at;
    constructor();
    readonly abstract w: number;
    readonly abstract z: string;
    ...
    readonly abstract d: boolean;
    protected get_e(): boolean;
    readonly e: boolean;
    readonly abstract f: boolean;
    readonly abstract i: boolean;
    readonly abstract h: boolean;
    abstract item(a: number): string;
    abstract item1(a: string): string;
    abstract item2(a: string, b: string): string;
    readonly abstract ag: string;
    readonly abstract ai: string;
    readonly abstract aj: string;
    readonly abstract a5: XmlNameTable;
    readonly abstract a7: XmlNodeType;
    readonly abstract ak: string;
    readonly abstract v: string;
    readonly abstract a3: ReadState;
    readonly abstract ar: string;
    readonly abstract as: string;
    readonly abstract a8: XmlSpace;
    abstract au(): void;
...
export declare abstract class XmlWriter extends Base implements IDisposable {
    static $t: Type;
    constructor();
    readonly abstract as: WriteState;
    readonly abstract b: string;
    readonly abstract at: XmlSpace;
    abstract c(): void;
