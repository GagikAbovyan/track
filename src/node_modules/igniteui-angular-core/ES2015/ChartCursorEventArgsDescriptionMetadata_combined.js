...
export class SeriesViewerDescriptionMetadata extends Base {
    ...
    static c(a, b) {
        ...
        b.item("ChartTitle", "(w:Title)String");
        ...
        b.item("SyncChannel", "String");
        b.item("SynchronizeVertically", "Boolean");
        b.item("SynchronizeHorizontally", "Boolean");
