...
export class TypeDescriptionContext extends Base {
    ...
    b(a, b) {
        ...
        if (this.e.containsKey(a)) {
            ...
            c.a = EnumUtil.getEnumValue(TypeDescriptionWellKnownType_$type, EnumUtil.parse(TypeDescriptionWellKnownType_$type, f, true));
            c.k = h;
            c.l = g;
            c.f = i;
            this.e.item(a + "@@" + b, c);
    ...
    o(a, b, c) {
        if (TypeDescriptionMetadata.b(this.c)) {
            b = TypeDescriptionContext.k(b);
        }
        else {
            b = TypeDescriptionContext.l(b);
        }
        this.a.setPropertyValue(a, b, c);
    }
    h(a) {
