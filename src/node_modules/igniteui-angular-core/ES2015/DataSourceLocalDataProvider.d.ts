...
export declare class DataSourceLocalDataProvider extends Base implements IDataSourceLocalDataProvider {
    ...
    private p(schemaItem_);
    private aa(a, item_, propertyName_, b);
    private z(a, item_, propertyName_);
    private q(item_, propertyName_);
    private b(item_, propertyName_);
    private static c(value_);
    private u();
