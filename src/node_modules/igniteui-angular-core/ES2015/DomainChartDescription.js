...
export class DomainChartDescription extends Description {
    constructor() {
        ...
        this.bu = null;
        this.bt = null;
        this._SeriesAddedRef = null;
        this._SeriesRemovedRef = null;
        this._SeriesPointerEnterRef = null;
        this._SeriesPointerLeaveRef = null;
        this._SeriesPointerMoveRef = null;
        this._SeriesPointerDownRef = null;
        this._SeriesPointerUpRef = null;
        this._CalloutStyleUpdatingRef = null;
    }
    get_type() {
        return "DomainChart";
    }
